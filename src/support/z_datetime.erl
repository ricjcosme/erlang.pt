...
timesince(Date, Base, Context) ->
    timesince(Date, Base, ?__(<<"">>, Context), ?__(<<"agora">>, Context), ?__(<<"em">>, Context), Context).
...
reldate(D1, D2, Context) ->
	case diff(D1,D2) of
		{{0,0,0},{0,0,0}} -> {"agora",[]};
		{{0,0,0},{0,0,S}} when S < 10 -> {?__(<<"momentos">>,Context),[]};
		{{0,0,0},{0,0,S}} -> {plural(S, ?__(<<"segundo">>,Context), ?__(<<"segundos">>,Context)), 
		                      []};
		{{0,0,0},{0,I,S}} -> {plural(I, ?__(<<"minuto">>,Context), ?__(<<"minutos">>,Context)), 
		                      plural(S, ?__(<<"segundo">>,Context), ?__(<<"segundos">>,Context))};
		{{0,0,0},{H,I,_}} -> {plural(H, ?__(<<"hora">>,Context),   ?__(<<"horas">>,Context)), 
		                      plural(I, ?__(<<"minuto">>,Context), ?__(<<"minutos">>,Context))};
		{{0,0,D},{H,_,_}} -> {plural(D, ?__(<<"dia">>,Context),    ?__(<<"dias">>,Context)),
		                      plural(H, ?__(<<"hora">>,Context),   ?__(<<"horas">>,Context))};
		{{0,M,D},{_,_,_}} -> {plural(M, ?__(<<"mês">>,Context),  ?__(<<"meses">>,Context)), 
		                      plural(D, ?__(<<"dia">>,Context),    ?__(<<"dias">>,Context))};
		{{Y,M,_},{_,_,_}} -> {plural(Y, ?__(<<"ano">>,Context),   ?__(<<"anos">>,Context)), 
		                      plural(M, ?__(<<"mês">>,Context),  ?__(<<"meses">>,Context))}
	end.
