...
LiveValidation.prototype = 
{
     ...
     */
     ...
     createSpinnerSpan: function(){
         ...
         span.innerHTML = '<img src="/lib/images/spinner.gif" height="16" width="16" alt="Validando..." />';
         return span;
     },
...
var Validate = {
   ...
   *                           (DEFAULT: false)
    ...
    Confirmation: function(value, paramsObj){
        ...
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "Não coincide.";
